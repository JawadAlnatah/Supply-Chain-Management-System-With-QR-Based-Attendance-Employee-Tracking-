...
| **Mohammad Khalid Alqallaf** | QA Lead & Documentation | • Test plan documentation (this STS document)<br>• Execute full test suite using `mvn test`<br>• Report defects and track fixes<br>• Unit testing for AuditLogDAO<br>• Integration testing for audit logging module<br>• Generate test execution reports |
| **Mustafa AbdulKarim** | Backend Developer & Database Designer | • Unit testing for InventoryDAO<br>• Unit testing for RequisitionDAO<br>• Integration testing for requisition creation workflow<br>• Test data preparation and database seeding<br>• Database connection testing and SSL/TLS verification |
| **Abdullah Abdulaziz Alhamadi** | Frontend Developer & GUI Designer | • Manual UI testing for LoginController<br>• Manual testing for Admin Dashboard UI<br>• User acceptance testing for admin role scenarios<br>• Test JavaFX FXML views and CSS styling<br>• Report UI bugs and usability issues |
| **Ahmed Hussain Alghazwe** | Frontend Developer | • Manual UI testing for Employee Dashboard<br>• Manual testing for Requisition Creation UI<br>• User acceptance testing for employee and manager role scenarios<br>• Test navigation and role-based access control<br>• Exploratory testing for edge cases |
| **Abdullah Jaffer Masiri** | UI/UX Designer | • Design and review test scenarios for UI/UX<br>• Validate visual consistency and usability<br>• Test accessibility and responsive design<br>• Document UI/UX testing findings<br>• Coordinate with frontend developers on test results |
